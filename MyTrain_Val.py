...
from utils.data_val1 import get_loader, test_dataset
...
def train(train_loader, model, optimizer, epoch, save_path, writer):
    ...
    try:
        for i, (images, gts, edges) in enumerate(train_loader, start=1):
            ...
            loss_init = structure_loss(preds[0],gts) + structure_loss(
                preds[1],gts) + structure_loss(preds[2],gts)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batchsize', type=int, default=14, help='training batch size')  #  默认24 
    ...
    parser.add_argument('--train_root', type=str, default='/media/lab509-1/data1/RJC/CODDataset/TrainDataset/',
                        help='the training rgb images root')
    parser.add_argument('--val_root', type=str, default='/media/lab509-1/data1/RJC/CODDataset/TestDataset/CAMO/',#/media/lab509-1/data/RJC/CODDataset/TestDataset/CHAMELEON
                        help='the test rgb images root')
    parser.add_argument('--save_path', type=str,
                        default='./snapshot/SCPNet/',
